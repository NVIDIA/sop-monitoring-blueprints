...
"""
Conftest for data_generation_pipeline integration tests - ensures correct module imports.
"""
...
modules_to_clear = [
    ...
    if key.startswith(("utils", "components", "app", "validation")) and key != "utils.logger"
]
